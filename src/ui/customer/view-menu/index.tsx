...
const dishesByCategory = {
  1: [ // Rice & Curry
    { id: 1, name: "Rice & Curry Special", price: 1850.00, image: "/sample-dish.png", available: true },
    { id: 2, name: "Fish Curry with Rice", price: 1650.00, image: "/sample-dish.png", available: true },
    { id: 3, name: "Chicken Curry Rice", price: 1750.00, image: "/sample-dish.png", available: true },
    { id: 4, name: "Vegetable Curry Rice", price: 1450.00, image: "/sample-dish.png", available: true },
    { id: 5, name: "Dhal Curry Rice", price: 1250.00, image: "/sample-dish.png", available: true },
    { id: 6, name: "Coconut Rice Special", price: 1950.00, image: "/sample-dish.png", available: true },
  ],
  2: [ // Kottu
    { id: 7, name: "Chicken Kottu", price: 1200.00, image: "/sample-dish.png", available: true },
    { id: 8, name: "Beef Kottu", price: 1450.00, image: "/sample-dish.png", available: true },
    { id: 9, name: "Vegetable Kottu", price: 950.00, image: "/sample-dish.png", available: true },
    { id: 10, name: "Cheese Kottu", price: 1350.00, image: "/sample-dish.png", available: true },
  ],
  3: [ // Hoppers
    { id: 11, name: "Plain Hoppers (4pcs)", price: 600.00, image: "/sample-dish.png", available: true },
    { id: 12, name: "Egg Hoppers (3pcs)", price: 850.00, image: "/sample-dish.png", available: true },
    { id: 13, name: "Milk Hoppers (4pcs)", price: 750.00, image: "/sample-dish.png", available: true },
    { id: 14, name: "Hoppers with Curry", price: 1200.00, image: "/sample-dish.png", available: true },
    { id: 15, name: "Sweet Hoppers", price: 650.00, image: "/sample-dish.png", available: true },
  ],
  4: [ // Seafood
    { id: 16, name: "Fish Ambul Thiyal", price: 2200.00, image: "/sample-dish.png", available: true },
    { id: 17, name: "Crab Curry", price: 3500.00, image: "/sample-dish.png", available: true },
    { id: 18, name: "Prawn Curry", price: 2800.00, image: "/sample-dish.png", available: true },
  ],
  5: [ // String Hoppers
    { id: 19, name: "String Hoppers (8pcs)", price: 850.00, image: "/sample-dish.png", available: true },
    { id: 20, name: "String Hoppers with Chicken", price: 1350.00, image: "/sample-dish.png", available: true },
    { id: 21, name: "String Hoppers with Fish", price: 1450.00, image: "/sample-dish.png", available: true },
    { id: 22, name: "String Hoppers with Dhal", price: 1150.00, image: "/sample-dish.png", available: true },
  ],
  6: [ // Rotis
    { id: 23, name: "Pol Roti", price: 450.00, image: "/sample-dish.png", available: true },
    { id: 24, name: "Coconut Roti", price: 500.00, image: "/sample-dish.png", available: true },
    { id: 25, name: "Gotukola Roti", price: 550.00, image: "/sample-dish.png", available: true },
  ],
  7: [ // Desserts
    { id: 26, name: "Kiribath with Jaggery", price: 450.00, image: "/sample-dish.png", available: true },
    { id: 27, name: "Watalappan", price: 650.00, image: "/sample-dish.png", available: true },
  ],
  8: [ // Beverages
    { id: 28, name: "King Coconut", price: 250.00, image: "/sample-dish.png", available: true },
    { id: 29, name: "Ceylon Tea", price: 200.00, image: "/sample-dish.png", available: true },
    { id: 30, name: "Wood Apple Juice", price: 350.00, image: "/sample-dish.png", available: true },
  ],
};
