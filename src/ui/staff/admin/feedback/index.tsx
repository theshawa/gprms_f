...
const mockFeedbackData = {
  ...
  feedbacks: [
    {
      id: 1,
      customerName: "Priyanka Wickramasinghe",
      rating: 5,
    ...
    {
      id: 2,
      customerName: "Mahinda Rathnayake",
      rating: 2,
    ...
    {
      id: 4,
      customerName: "Roshan Jayawardena",
      rating: 5,
  ...
  staffRatings: [
    { name: "Nuwan Silva", rating: 4.8, feedbacks: 45 },
    { name: "Tharaka Perera", rating: 4.7, feedbacks: 38 },
    { name: "Sanduni Fernando", rating: 4.6, feedbacks: 42 },
    { name: "Kasun Rajapaksa", rating: 4.3, feedbacks: 35 },
  ],
};
      ...
      <CardContent>
        ...
        <Stack direction="row" justifyContent="space-between" alignItems="center" mb={2}>
          <Stack direction="row" spacing={2} alignItems="center">
            ...
            <Typography variant="caption" color="text.secondary">
              <strong>Order:</strong> LKR {feedback.orderValue.toLocaleString()}
            </Typography>
          </Stack>
          <Chip
